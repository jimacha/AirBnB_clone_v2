...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        """To prints the string representation of an instance
        Exceptions:
            SyntaxError: when there is no args given
            NameError: when there is no object taht has the name
    ...
    def count(self, line):
        ...
        try:
            ...
            print("**a class does not exist**")

    def strip_clean(self, args):
        """strip the argument and return a  command string
        Args:
    ...
    def default(self, line):
        """retrieve the instances of a class and
